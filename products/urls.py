...
urlpatterns = [
    ...
    url(r'products/$', login_required(views.ProductClassView.as_view(), login_url='login'), name='product_class_index'), 
    url(r'products/(?P<id>[0-9]+)', views.ProductClassView.as_view(template_name='product_index.html'), name='product_class_refresh'),
